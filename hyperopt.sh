...
THEANO_FLAGS="device=gpu0" python CoMET.py crispr 50 5 -e 200 --conv 1 --fc 2 --rate .01 > logs/log0.txt &
THEANO_FLAGS="device=gpu1" python CoMET.py crispr 200 5 -e 100 --conv 1 --fc 2 --rate .01 > logs/log1.txt &
THEANO_FLAGS="device=gpu2" python CoMET.py crispr 100 5 -e 200 --conv 1 --fc 2 --rate .01 > logs/log2.txt &
